        ...
        $db_config = Array
            ...
            switch( $para )
            {
                ...
                case "save_to_disc":
                                                ...
                                                $dbimexport->download_path = FCPATH.'assets/ad';
                                                $dbimexport->file_name = "auto_save";
                                                $dbimexport->export();
                                                break;

                case "import":
                                                $dbimexport->import_path = FCPATH.'assets/ad/auto_save.xml';
                                                $dbimexport->import();
                                                break;
            }
            $data['module']='admin';
            $data['page']='import_export';
            $this->load->view('admin_container',$data);
...
$bkup = 'backups/' . date('Y-m-d') .'_'. $db_name . '.txt';
$fp   = fopen($bkup, "w");
...
// ALL DONE
fclose($fp);
    flashMsg('success','Congratulations !! Database back up completed!!');   
    redirect_back();
    }
