...
<div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <div class="content-box"><!-- Start Content Box -->
                ...
                <?php echo displayStatus(); ?>
                    ...
                    <p><a class="button" href="<?php echo site_url('auth/create_agent');?>">Create a new Agent</a>&nbsp;<a class="button" href="<?php echo site_url('auth/create_staff');?>">Create a new Staff</a></p>
...
<p>
            ...
            <?php }elseif($user->groups[0]->name == 'admin'){?>
                <a href="<?php  echo site_url('auth/edit_staff/'.$user->id)?> " title="Edit"><img src="<?php echo ASPATH ; ?>/images/icons/pencil.png" alt="Edit" /></a>
                <a href="<?php echo site_url('auth/delete_user/'.$user->id)?>" title="Delete" onclick="return(confirm('Do you really want to delete?'))"><img src="<?php echo ASPATH ; ?>/images/icons/cross.png" alt="Delete" /></a>
