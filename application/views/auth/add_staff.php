<div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <div class="content-box"><!-- Start Content Box -->
                ...
                <?php echo displayStatus(); ?>
                    ...
                    <div > <!--class="tab-content" id="tab2"-->
                                ...
                                <form action="<?php echo site_url('auth/create_staff')?>" method="post">
      ...
      <td width="25%;" style="text-align:right;"><label>Password: </label></td> <td width="50%" style="text-align:center;">
