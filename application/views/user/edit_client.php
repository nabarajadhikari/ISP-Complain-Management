<div id="shortcuts" class="clearfix" style="width:740px !important;">
             <h2 class="ico_mug">Edit Client <div style="float:right;"><a href="<?php echo site_url('auth/index')?>"><img src="<?php echo base_url() ; ?>assets/admin/img/home.png" height="22px;" alt="home" /></a><div></h2>
            
                <?php echo displayStatus(); ?>
                                <?php  echo form_open_multipart('user/edit_client/'.$id)?>
                                    
                                    <fieldset  class="left" style="width:720px !important;">
                                    <p> <input type="hidden" value="<?php echo $id?>" name="id">  
...
<p>   
                                    ...
                                    <label>Renew Date:</label> 
                                         <?php echo form_input($renew_date); ?>
                                         <small>This field is required.</small> 
                                     </p>
                                     <p>   
