...
<tr>
    <td colspan="10"> <?php 
            if($this->session->userdata('assigned_technecian'))
            {
              ...
              {
                if($this->session->userdata('created_date_u')) echo 'Created Date= From '.$this->session->userdata('created_date_l').' To '.$this->session->userdata('created_date_u').'<br/>';
                else
                 echo 'Created Date ='.$this->session->userdata('created_date_l').'<br/>';
              }
...
<tr>
                                    ...
                                    <td><?php echo DiffDate($le[$i]->created_date,$le[$i++]->finished_date);?></td>
