...
define("E_VAL_RECAPTCHA_FAILED","Please enter the correct code for %s"); 



/**  E_VAL_RECAPTCHA_FAILED
          ...
          case "recaptcha_matches":
                                {
                                    ...
                                    {
                                      $bret= false;
                                      $default_error_message = sprintf(E_VAL_RECAPTCHA_FAILED,$variable_name,$command_value);  
                                    }
                                    break;
                                }
