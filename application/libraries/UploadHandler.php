...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'upload_dir' => FCPATH.'new_media/',
            'upload_url' => base_url().'new_media/',
            'user_dirs' => false,
            'mkdir_mode' => 0777,
            'param_name' => 'files',
    ...
    protected function get_upload_path($file_name = null, $version = null, $type=null) {
        $file_name = $file_name ? $file_name : ''; 
        $type_str=explode('/',$type);
        $type_name=$type_str[0];
        return $this->options['upload_dir'].$type_name.'/'.$file_name;
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file_path = $this->get_upload_path($file->name,NULL,$type);
